...
AreaDeFiguras figuras = new AreaDeFiguras();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Calcular Area Del Cuadrado");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int lado1cua, lado2cua;
        lado1cua = Integer.parseInt(jTextField1.getText());
        lado2cua = Integer.parseInt(jTextField2.getText());
        
        figuras.setLado1cua(lado1cua);
        figuras.setLado2cua(lado2cua);
